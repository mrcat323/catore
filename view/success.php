		...
		<div class="row row-offcanvas row-right">
				...
				<div class="panel">
					...
					<div class="panel-body">
						<b>Вы успешно отправили Ваше сообщение Администратору!</b><br>
						<i>Администратор расмотрит Ваше сообщение, пожалуйста ждите ответа в своем <b>&nbsp;E-Mail</b> который Вы указали.</i><br>
						<br>
						<br>
						<br>
					</div>
