		...
		<div class="row row-offcanvas row-right">
				...
				<div class="panel">
					<div class="panel-heading">
						<h2 class="text-center">Обратная Связь <i class="fa fa-phone"></i></h2>
					...
					<div class="panel-body">
						<div class="col-sm-10 col-md-offset-1">
							<form class="form" action="/about/addhelp/" method="post">
								<tr>
									<td>
										<input class="form-control" type="text" placeholder="Ваше Имя" name="name" id="">
									</td>
								</tr><br>
								<tr>
									<td>
								...
								<tr>
									<td>
										<textarea name="message" id="" cols="30" rows="10" placeholder="Ваше Сообщение" class="form-control"></textarea>
									</td>
								</tr><br>
								<tr>
									<td>
										<button class="btn btn-lg btn-danger form-control">Отправить</button>
									</td>
								</tr>
							</form>
						</div>
