		...
		<div class="row row-offcanvas row-right">
				...
				<div class="panel">
					...
					<?php foreach($data as $s): ?>  
						<div class="col-sm-4">
							<div class="panel">
									<form name="formcart" action="/cart/add/?code=<?php echo $s['code'];?>" method="POST">
									<div class="panel-body">
										<img src="<?php echo $s['image'];?>" width="100" height="100" alt="">
										<b><a href="/product/show/<?php echo $s['id']; ?>"><?php echo $s['title']; ?></a></b>
										<p class="text text-right"><?php echo $s['price'] . " <i class='fa fa-rub'></i>";?></p>
