...
<head>
	...
	<title>Товары по категориям</title>
...
<body>
	...
	<div class="section-center">
		<div class="row row-offcanvas row-right">
				...
				<h2 class="text-center">Это категория <?php echo $key["title"]; ?></h2>
			<?php endforeach ?>
				<?php if(isset($_SESSION['cart_item'])): ?>
					...
					<?php foreach($d as $b): ?>  
						<div class="col-sm-4">
							<div class="panel">
									<form name="formcart" action="/cart/add/?code=<?php echo $b['code'];?>" method="POST">
									<div class="panel-body">
										<img src="<?php echo $b['image'];?>" width="100" height="100" alt="">
										<b><a href="/product/show/<?php echo $b['id']; ?>"><?php echo $b['title']; ?></a></b>
										<p class="text text-right"><?php echo $b['price'] . " " . $b['note'];?></p>
										<div class="quantity"><p>кол. <input type="text" name="quantity" value="1"></p>
										</div>
										<input class="btn btn-warning" type="submit" value="В корзину">
									</div>
									</form>
							</div>
						</div>
