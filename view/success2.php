		...
		<div class="row row-offcanvas row-right">
				...
				<div class="panel">
					<div class="panel-heading">
						<h2 class="text-center">Ваш заказ будет посмотрен Администраторам, данный момент Вам надо оплатить Ваш заказ</h2>
					</div>
					<div class="panel-body">
<?php
if(isset($_SESSION["cart_item"]) && isset($_SESSION["total"])):
?>	
<?php		
    foreach ($_SESSION["cart_item"] as $item):	?>
				<form id="payment" name="payment" method="post" action="https://sci.interkassa.com/" enctype="utf-8">
				<input type="hidden" name="ik_co_id" value="599e90ec3b1eafc44c8b456c" />
				<p>Вы заказали <?php echo $item['title'];?> | <?php echo $item['price'];?> <i class="fa fa-rub"></i></p>
				<input type="hidden" name="ik_pm_no" value="<?php echo $item['code'];?>" />
				<input type="hidden" name="ik_am" value="<?php echo $item['price'];?>.00" />
				<input type="hidden" name="ik_cur" value="RUB" />
				<input type="hidden" name="ik_desc" value="<?php echo $item['title'];?>" />
