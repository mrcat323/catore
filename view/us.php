		...
		<div class="row row-offcanvas row-right">
				...
				<div class="panel">
					...
					<div class="panel-body">
						<p>Мы (CaTsEmPiRe) недавно создали микро-фреймворк <a href="http://github.com/eazy-english/catoolin">CATOOLIN</a>. Прошу заметить что <a href="http://github.com/eazy-english/catoolin">CATOOLIN</a> ускоряет разработку Веб приложений. Он довольно прост, удобен. И CATORE был создан мною в целях практики и опыта</p>
						<br>
