...
<head>
	...
	<title>Search for <?php echo $word; ?></title>
		...
		<nav class="navbar navbar-default" role="navigation">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					...
					<form action="/section/search/" class="navbar-form navbar-left" method="GET" role="search">
	...
	<div class="section-center">
		<div class="row row-offcanvas row-right">
				...
				<div class="panel">
					...
					<h2 class="text-center">Searching for <em><?php echo $word; ?></em></h2>
					...
					<ol>
						<?php foreach ($search as $engine): ?>
							<li>
								<a href="/product/show/<?php echo $engine['id'];?>"><?php echo $engine['title'];?></a>
							</li>
