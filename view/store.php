		...
		<div class="row row-offcanvas row-right">
				...
				<div class="panel">
					<div class="panel-heading">
						<h2 class="text-center">О интернет магазине CATORE</h2>
					</div>
					<div class="panel-body">
						<p>Интернет магазин CATORE. На данный момент все товары интернет магазина являються не действительными, и поэтому Вам не стоит делать покупки каких либо товаров.</p>
						<p>CATORE был создан микро-фреймворком <a href="http://github.com/eazy-english/catoolin">CATOOLIN</a> в целях практики и опыта. Прошу Вас заметить что <a href="http://github.com/eazy-english/catoolin">CATOOLIN</a> ускоряет разработку Вашего проекта, он прост и хорош</p>
