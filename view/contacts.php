		...
		<div class="row row-offcanvas row-right">
				...
				<div class="panel">
					...
					<div class="col-md-offset-4">
						<img src="https://i.mycdn.me/image?id=836777543585&t=0&plc=WEB&ts=00&tkn=*8hb8o5dGIxpgigCFsG0DJqgBG_A" alt="" class="img-responsive img-circle" width="150" height="150">
						<h2 class="peter">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mr CaT</h2>
						<h3 class="peter text-muted">&nbsp;&nbsp;Web Developer</h3>
					</div>
